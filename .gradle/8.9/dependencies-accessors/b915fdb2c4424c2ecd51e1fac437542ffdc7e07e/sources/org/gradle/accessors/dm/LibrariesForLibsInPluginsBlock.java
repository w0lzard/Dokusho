...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class CoilNetworkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ktor2</b> with <b>io.coil-kt.coil3:coil-network-ktor2</b> coordinates and
         * with version reference <b>coil3</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getKtor2() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("coil.network.ktor2");
        }
    ...
    public static class JetbrainsComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>navigation</b> with <b>org.jetbrains.androidx.navigation:navigation-compose</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getNavigation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("jetbrains.compose.navigation");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coil3</b> with value <b>3.0.0-rc02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sqlite</b> with value <b>2.5.0-alpha11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
         ...
         *    <li>io.coil-kt.coil3:coil-network-ktor2</li>
         *    <li>io.coil-kt.coil3:coil-network-ktor3</li>
